    ...
    return (
        <>
            <section id='contact' className="bg-[#f2a44c] dark:bg-[#101820] py-[2rem] md:px-5 px-2 gap-40">
                ...
                <motion.h2 className="font-lilita dark:text-[#f2a44c] text-[#101820] lg:text-[4rem] md:text-[3rem] text-[2rem] text-center w-[100%] sm:hidden">CONTACT ME</motion.h2>
                <motion.div initial={{ opacity: 0, x: 100 }}
                      whileInView={{ opacity: 1, x: 0 }}
                      transition={{ duration: 0.5, easeIn, delay:0.2 }}
                      viewport={{ once: true}} className="sm:w-[50vw] flex gap-3 justify-center items-center py-8 sm:hidden flex-wrap">
                        <div>
                    ...
                    <motion.div initial={{ opacity: 0, x: -100 }}
                      whileInView={{ opacity: 1, x: 0 }}
                      transition={{ duration: 0.5, easeIn, delay:0.2 }}
                      viewport={{ once: true}} className="sm:w-[50vw]">
                    ...
                    <motion.div initial={{ opacity: 0, x: 100 }}
                      whileInView={{ opacity: 1, x: 0 }}
                      transition={{ duration: 0.5, easeIn, delay:0.2 }}
                      viewport={{ once: true}} className="sm:w-[50vw] hidden sm:block">
                        <div>
